...
function mvp_share_count() {
	...
	$post_id = get_the_ID(); ?>
<?php $soc_tot = get_tweets( $post_id ) + get_fb( $post_id ) + get_plusones( $post_id ) + get_pinterest( $post_id ); if ($soc_tot > 999999999) {
			...
			<?php if($soc_format==0) { ?>
						<?php } elseif($soc_format==1) { ?>
							<li class="post-social-count">
								<span class="social-count-num"><?php echo esc_html( $soc_format ); ?></span>
...
/*---------------------------------------------------------  (min-width: 1042px) and (max-width:1799px)  -------------------------------------------------*/
/*---------------------------------------------------------  (min-width: 1042px) and (max-width:1799px)  -------------------------------------------------*/
/*---------------------------------------------------------  (min-width: 1042px) and (max-width:1799px)  -------------------------------------------------*/
/*---------------------------------------------------------  (min-width: 1042px) and (max-width:1799px)  -------------------------------------------------*/
/*---------------------------------------------------------  (min-width: 1042px) and (max-width:1799px)  -------------------------------------------------*/

@media screen and (min-width: 1042px) and (max-width:1799px){
#featured-multi-wrap,#featured-multi-main{
	height: 240px;
	}
	.featured-multi-sub{
		height: 119.5px;
...
<?php } if(get_option('mvp_site_layout') == 'Full-Width') {?>
@media screen and (min-width: 1003px) and (max-width: 1041px){
...
<?php $sticky_side = get_option('mvp_sticky_sidebar'); 
  if ($sticky_side == "true") { 
      if (isset($sticky_side)) { } 
	  } 
	  else 
	  { 
         if (isset($sticky_side)) 
